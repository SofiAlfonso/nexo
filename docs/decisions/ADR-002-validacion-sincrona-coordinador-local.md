...
- 26-09-2026: PoC ejecutada en Minikube con F1 RED-01, **aprobada**: C4 cortado 300 s, N2 100 %, p95 de C2 ≈ 24 ms, 0 duplicados ([f1-red-01.md](../fault-experiments/f1-red-01.md)). El estado no cambia, porque el criterio exige un corte de 15 min y F1 cortó 5 min.
